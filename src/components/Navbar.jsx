...
export default function Navbar() {
  ...
  return (
    <nav className="mb-12 text-white flex justify-between items-center border-b border-[#E5E7EB] tracking-tight w-full gap-x-12 py-6 px-[9.5vw]">
      ...
      <ul
        ...
        } absolute top-0 bg-[#11141d] lg:bg-transparent lg:relative h-screen lg:h-fit w-full lg:w-fit ease-in-out flex flex-col justify-center lg:flex-row lg:gap-12 lg:justify-between lg:items-center text-base md:text-lg`}
      >
        <li>Timeline</li>
        <button
          className="mt-[1.8rem] bg-gradient-to-r from-[#903AFF] via-[#D434FE] to-[#FF26B9] w-[10.8rem] h-[3.3rem] lg:hidden"
          //   onClick={(e) => {
          //     e.preventDefault();
